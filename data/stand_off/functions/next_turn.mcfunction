...
execute as @p[tag=standoff, tag=!other] run give @s minecraft:written_book{pages:["[\"\",{\"text\":\"[Precision Shot]\",\"underlined\":true,\"color\":\"dark_green\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/trigger precision_shot set 1\"}},{\"text\":\"\\n\"},{\"text\":\"\\n\"},{\"text\":\"Drag an armor stand with a fishing rod\"}]","[\"\",{\"text\":\"[Retreat]\",\"underlined\":true,\"color\":\"dark_green\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/trigger retreat set 1\"}},{\"text\":\"\\n\"},{\"text\":\"\\n\"},{\"text\":\"Throw the fishing bobber to any of your armor stand, then sneak on any of your spawn point to teleport your armor stand\"}]","[\"\",{\"text\":\"[Switch Place]\",\"underlined\":true,\"color\":\"dark_green\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/trigger switch_place set 1\"}},{\"text\":\"\\n\"},{\"text\":\"\\n\"},{\"text\":\"Throw the fishing bobber to any of your armor stand, then sneak close to any other armor stand to switch these armor stands\",\"hoverEvent\":{\"action\":\"show_text\",\"contents\":[\"\"]}}]","{\"text\":\"[Force Next Turn]\",\"bold\":true,\"underlined\":true,\"color\":\"dark_red\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/trigger force_next_turn set 1\"},\"hoverEvent\":{\"action\":\"show_text\",\"contents\":{\"text\":\"If you're stuck in the same turn, after hitting a pawn\"}}}"],title:"Bonus",author:"Stand Off", Tags:["standoff"]}
