...
execute if score @s switch_place matches 1 run tellraw @a[tag=standoff] ["", {"selector": "@s", "color": "aqua"}, {"text": " uses "}, {"text": "[Switch Place]", "color": "dark_green", "hoverEvent": {"action": "show_item", "value": "{'id':'minecraft:armor_stand', 'Count':1}"}}]
