...
execute if score @s retreat matches 2 if entity @s[tag=player1] as @e[type=fishing_bobber, nbt={Motion:[0d,0d,0d]}, tag=standoff, tag=retreat] at @s unless entity @e[type=minecraft:armor_stand, tag=standoff, tag=player1, dx=0.1, dy=0.1, dz=0.1] run kill @s
execute if score @s retreat matches 2 if entity @s[tag=player2] as @e[type=fishing_bobber, nbt={Motion:[0d,0d,0d]}, tag=standoff, tag=retreat] at @s unless entity @e[type=minecraft:armor_stand, tag=standoff, tag=player2, dx=0.1, dy=0.1, dz=0.1] run kill @s
